	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float mulTime19 = _TimeParameters.x * _PanSpeed;
				float2 appendResult17 = (float2(0.0 , mulTime19));
				float2 texCoord13 = packedInput.ase_texcoord.xy * appendResult21 + appendResult17;
...
/*ASEBEGIN
Version=18916
592;73;931;641;1324.593;358.9068;1.3;False;False
...
ASEEND*/
//CHKSM=69E65C1DB1450B74EA610EA49739676090BD87CA