	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 texCoord16 = packedInput.ase_texcoord.xy * float2( 2,2 ) + float2( 0,0 );
...
/*ASEBEGIN
Version=18916
592;73;931;641;1013.188;576.5351;2.101362;True;False
...
ASEEND*/
//CHKSM=69DC163A62822F158473CCDB1D17C96E1B62346F