	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_DirtAlbedo = packedInput.ase_texcoord.xy * _DirtAlbedo_ST.xy + _DirtAlbedo_ST.zw;
				float4 tex2DNode11 = SAMPLE_TEXTURE2D( _DirtAlbedo, sampler_DirtAlbedo, uv_DirtAlbedo );
				
				float2 uv_DirtNormal = packedInput.ase_texcoord.xy * _DirtNormal_ST.xy + _DirtNormal_ST.zw;
...
/*ASEBEGIN
Version=18916
592;73;742;408;1339.696;133.5417;2.359291;False;False
...
ASEEND*/
//CHKSM=9351BD76D8D868E4A934A2DB29102F9C9E6021D3